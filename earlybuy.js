...
//  BUSD: '0x55d398326f99059ff775485246999027b3197955', gabisa, pake wbnb dulu
  ...
  recipient: '0xeC4245dd740d4Ec7759491A1C8C5d25B9E8cbF92' //address walletmu
};
...
const provider = new ethers.providers.WebSocketProvider('https://rough-winter-flower.bsc.quiknode.pro/cd2e6d77b58ccf34119705fd50f0222cef171122/'); //private node lebih gud
...
try {
  ...
  var targettoken = '0xad890F724bf4B941b51E817f7F3efBc1d9F7C9b1'; //targettoken isi targettoken kalian
  //if(tokenOut === targettoken){ //kalo pake ini hapus komen, di line 129 juga
  if(pairBNBvalue > 25000000000000000){ //minimal liquidity 25 BNB https://eth-converter.com
